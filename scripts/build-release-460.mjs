...
const dist='dist';
const sourceSha=process.env.LIFEOS_SOURCE_SHA||process.env.GITHUB_SHA||'';
...
for(const signature of ['data-decision-what-now',"source:'what-now'",'What this protects','Opportunity cost','Best alternative'])if(!decisionSource.includes(signature))throw new Error(`Decision-backed What Now release invariant missing: ${signature}`);
